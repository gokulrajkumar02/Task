...
const PaymentPage = () => {
  const { ticketCount, appliedDiscount } = useDistrict();
  ...
  useEffect(() => {
    ...
    const bookingData = {
      ...
      discount: appliedDiscount ? `${appliedDiscount * 100}%` : "none",
      bookedAt: new Date().toISOString(),
    };

    setQrValue(JSON.stringify(bookingData));
  }, [selectEventDetails, ticketCount, appliedDiscount]);
  return (
        ...
        <div className="w-[90%] md:w-[50%] border border-gray-300 rounded-xl p-4">
          <div className="flex gap-5 items-center">
            ...
            <div>
              ...
              <span className="text-[14px] text-gray-600">Debit or credit · tap or insert</span>
            </div>
          </div>
        </div>
        <div className="w-[90%] md:w-[50%] border border-gray-300 rounded-xl p-4">
