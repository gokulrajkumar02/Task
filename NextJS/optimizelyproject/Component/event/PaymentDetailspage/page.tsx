...
const PaymentPage = () => {
  ...
  const price = selectEventDetails?.price || 0;
  const orderAmount = ticketCount * price;
  const feesCharges = orderAmount * 0.1;
  const grandTotal = orderAmount + feesCharges;

  const discountAmount = grandTotal * appliedDiscount;
  ...
  return (
    <div className="w-full flex flex-col items-center overflow-auto scrollbar-hide">
      ...
      <div className="mx-5 md:w-[50%] mt-10 border border-gray-200 shadow-xl rounded-xl">
        ...
        <div className="p-4">
          ...
          <div className="border border-gray-200 rounded-xl mt-5 p-4 space-y-3">
            ...
            <div className="flex justify-between text-[15px]">
              <h1>
                {ticketCount} <span className="text-gray-500">tickets</span>
              </h1>
          ...
          <div
            ...
            onClick={() => router.push("/event/EventOfferDetails")}
          >
          ...
          <div className="mt-2 font-semibold text-[#242e44] border-b border-gray-200 pb-3">
            <div className="flex justify-between ">
              <h1>Grand Total</h1>
              <span className={clsx(isDiscountApplied && "line-through")}>
                ₹{grandTotal}
              </span>
            </div>
            {isDiscountApplied && (
              <div className="font-light text-[14px] text-gray-500 flex justify-between">
                <h1>Discount amount - {appliedDiscount * 100}%</h1>
          ...
          <button
            ...
            onClick={() => router.push("/event/PaymentPage")}
          >
            Continue
          </button>
        </div>
