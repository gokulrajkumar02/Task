    ...
    <div className="mx-5 md:w-[50%] md:mx-auto mt-10 space-y-4">
      ...
      {eventTicketOffer.map((offer) => {
        const isApplied =
          appliedDiscount !== 0
            ...
            : activityDiscount === offer.discount;
        return (
          <div
            key={offer.id}
      ...
      <div className="mt-5 flex justify-center md:justify-end gap-4">
        <button
          ...
          onClick={() => {
            if (!isActivityDiscountApplied) setActivityDiscount(0);
            router.back();
          }}
        >
          Back
        ...
        <button
          ...
          onClick={() => {
            ...
            setIsActivityDiscountApplied(true);
            setActivityDiscount(appliedDiscount);
            router.back();
          }}
        >
          Apply
...
export default ActivityOfferDetails;
