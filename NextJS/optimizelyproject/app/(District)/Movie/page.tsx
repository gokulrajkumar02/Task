...
const MoviePage = () => {
  const { isDialogOpen ,theatreDetails,setTheatreDeatils } = useDistrict();
          ...
          <div className="flex gap-5 flex-col">
              ...
              <div className="flex flex-col justify-center">
                ...
                <div className="flex flex-col sm:flex-row items-center gap-2 text-sm text-gray-600">
                  <div className="flex gap-2 items-center p-0">
                    ...
                    <span>|</span>
                    <span className="border border-gray-300 px-2 py-[2px] rounded">
                      UA13+
                    </span>
                  </div>
            ...
            <div className="flex flex-col gap-3">
              <div className="flex gap-3 overflow-x-auto sticky top-20 z-50 bg-white">
                <div className="min-w-[60px] h-[60px] flex justify-center items-center sticky left-0 bg-white z-10">
                ...
                {selectedDate.map((item, index) => {
                  ...
                  return (
                    ...
                    className={`flex flex-col items-center justify-center px-3 py-2 rounded-xl w-[50px] cursor-pointer
                              ...
                              onClick={() => 
                                {
                                  ...
                                  setTheatreDeatils([show.time,item.name,show.screen,item.id])  
                                }}
                              key={show.time}
